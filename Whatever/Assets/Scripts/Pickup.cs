...
public class Pickup : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ChestInv = GameObject.FindGameObjectWithTag("Fridge").GetComponent<Fridge>();

        BackInv = GameObject.FindGameObjectWithTag("Case").GetComponent<Case>();
